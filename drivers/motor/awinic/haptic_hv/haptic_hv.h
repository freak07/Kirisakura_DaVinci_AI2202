...
#define AW_RAM_WORK_DELAY_INTERVAL		(2000)
...
//ASUS_BSP: disable #define AW_INPUT_FRAMEWORK
/* #define AW_TIKTAP */
/* #define AW_DOUBLE */
...
struct aw_haptic {
	...
	#ifdef ASUS_HAPTIC_PORTING
	struct delayed_work rtp_work_d;
	struct delayed_work asus_gain_work;
	#endif
...
struct aw_haptic_func {
	...
	#ifdef ASUS_HAPTIC_PORTING
	uint8_t (*get_gain)(struct aw_haptic *);
	#endif
};
