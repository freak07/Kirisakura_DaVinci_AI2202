...
static uint8_t aw869xx_get_glb_state(struct aw_haptic *aw_haptic)
{
	...
	i2c_r_bytes(aw_haptic, AW869XX_REG_GLBRD5, &state, AW_I2C_BYTE_ONE);
...
static void aw869xx_stop(struct aw_haptic *aw_haptic)
{
	...
	i2c_w_bytes(aw_haptic, AW869XX_REG_PLAYCFG4, &reg_val, AW_I2C_BYTE_ONE);
...
static int aw869xx_get_f0(struct aw_haptic *aw_haptic)
{
	...
	aw869xx_stop(aw_haptic);
	/* config max d2s_gain */
	i2c_r_bytes(aw_haptic, AW869XX_REG_SYSCTRL7, &reg_val, AW_I2C_BYTE_ONE);
	d2s_gain_default = reg_val & AW869XX_BIT_SYSCTRL7_D2S_GAIN;
	i2c_w_bits(aw_haptic, AW869XX_REG_SYSCTRL7,
...
static void aw869xx_misc_para_init(struct aw_haptic *aw_haptic)
{
	...
	/* Get gain */
	i2c_r_bytes(aw_haptic, AW869XX_REG_PLAYCFG2, reg_val, AW_I2C_BYTE_ONE);
