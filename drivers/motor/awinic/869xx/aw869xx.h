...
struct aw869xx {
	...
	struct aw869xx_dts_info info;
	struct ram ram;
	//struct timeval start, end;
	s64 start, end;
	struct aw869xx_pinctrl pinctrl;
	struct haptic_audio haptic_audio;
#ifdef AW_ENABLE_PIN_CONTROL
	struct pinctrl *aw869xx_pinctrl;
