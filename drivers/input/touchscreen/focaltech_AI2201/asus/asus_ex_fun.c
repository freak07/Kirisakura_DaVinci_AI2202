...
static struct proc_ops asus_ex_proc_realtime_ops = {
	.proc_write = asus_ex_proc_realtime_write,
	.proc_read  = asus_ex_proc_realtime_read,
};

static struct proc_ops asus_ex_proc_perftime_ops = {
	.proc_write = asus_ex_proc_perftime_write,
	.proc_read  = asus_ex_proc_perftime_read,
};
