...
static struct proc_ops asus_gesture_proc_type_ops = {
	.proc_write = asus_gesture_proc_type_write,
	.proc_read  = asus_gesture_proc_type_read,
};

static struct proc_ops asus_gesture_proc_dclick_ops = {
	.proc_write = asus_gesture_proc_dclick_write,
	.proc_read  = asus_gesture_proc_dclick_read,
};

static struct proc_ops asus_gesture_proc_swipeup_ops = {
	.proc_write = asus_gesture_proc_swipeup_write,
	.proc_read  = asus_gesture_proc_swipeup_read,
};
