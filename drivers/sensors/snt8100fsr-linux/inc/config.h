...
#define REQUEST_GRIP_FW_PATH   "snt8155.bin"
#define SEC_FW_PATH   "/vendor/etc/grip_fw/snt8100fsr.image_2nd"
...
#define VENDOR_FPC_FLAG_LOCATION "/vendor/factory/grip_fpc_flag"
/*
 * Times of load firmware workqueue timeout
 */
#define UPLOAD_FW_WQ_DELAY_LIMIT 1
...
#define WAIT_VIB_DISABLE_STATUS_CHANGE_COUNT 100

// Our interrupt name for the GPIO19 pin interrupt
#define IRQ_NAME            "at_host_int"
