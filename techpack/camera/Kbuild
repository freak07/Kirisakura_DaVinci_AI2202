...
ifeq ($(ASUS_AI2201_CAMERA), y)
KBUILD_CPPFLAGS += -DASUS_AI2201_PROJECT=1
endif

ifeq ($(ASUS_AI2202_CAMERA), y)
...
ifeq ($(ASUS_AI2201_CAMERA), y)
camera-$(CONFIG_SPECTRA_SENSOR) += \
	drivers/cam_sensor_module/cam_actuator/actuator_i2c.o \
	drivers/cam_sensor_module/cam_actuator/asus_actuator.o \
	drivers/cam_sensor_module/cam_sensor/asus_cam_sensor.o \
	drivers/cam_sensor_module/cam_flash/asus_flash.o
endif
...
camera-$(CONFIG_SPECTRA_SENSOR) += \
	drivers/cam_sensor_module/cam_actuator/actuator_i2c.o \
	drivers/cam_sensor_module/cam_ois/asus_ois.o \
	drivers/cam_sensor_module/cam_ois/dev_def.o \
	drivers/cam_sensor_module/cam_ois/asus_dev_imp.o \
	drivers/cam_sensor_module/cam_actuator/asus_actuator.o \
	drivers/cam_sensor_module/cam_sensor/asus_cam_sensor.o \
	drivers/cam_sensor_module/cam_flash/asus_flash.o
endif
